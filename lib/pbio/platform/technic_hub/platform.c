...
const pbdrv_ioport_pup_platform_data_t pbdrv_ioport_pup_platform_data = {
    ...
    .ports = {
        ...
        },
        {
            ...
            .pins = {
                .gpio1 = { .bank = GPIOC, .pin = 4  },
                .gpio2 = { .bank = GPIOA, .pin = 7  },
